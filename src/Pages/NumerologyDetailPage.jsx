...
export default function NumerologyDetailPage() {
    ...
    return (
      <div className="min-vh-100 d-flex align-items-center justify-content-center p-3">
        <div className="text-center">
          ...
          <p className="mt-3" style={{ color: '#332211' }}>Đang tải dữ liệu...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div 
      ...
      style={{
        background: "linear-gradient(135deg, #FFF9F0 0%, #FDFBF6 50%, #FFF5E8 100%)",
        position: 'relative',
        overflow: 'hidden'
      }}
    >
      ...
      <div className="position-absolute w-100 h-100" style={{ pointerEvents: 'none', top: 0, left: 0, zIndex: 0 }}>
        ...
        >
          <circle cx="60" cy="60" r="50" stroke="#E8C78C" strokeWidth="2" fill="none" />
          <circle cx="60" cy="60" r="35" stroke="#B8860B" strokeWidth="1.5" fill="none" />
          <circle cx="60" cy="60" r="20" stroke="#E8C78C" strokeWidth="1" fill="none" />
        </svg>
        ...
        >
          <polygon points="50,10 90,90 10,90" stroke="#E8C78C" strokeWidth="2" fill="none" />
          <circle cx="50" cy="50" r="30" stroke="#B8860B" strokeWidth="1.5" fill="none" />
        </svg>
      </div>
      ...
      {/* Main container */}
      <div className="container-fluid position-relative" style={{ zIndex: 1, padding: '2rem 1rem' }}>
          ...
          <div className="col-12 col-lg-10 col-xl-9">
            ...
            <div className="text-center mb-5" style={{ position: 'relative' }}>
              ...
              <div className="d-flex justify-content-center gap-3 flex-wrap">
                ...
                <Link 
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.transform = 'translateY(-2px)';
                    e.target.style.boxShadow = '0 6px 16px rgba(184, 134, 11, 0.4)';
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'translateY(0)';
            ...
            >
              ...
              <div 
                style={{
                  height: '4px',
                  background: 'linear-gradient(90deg, #B8860B, #E8C78C, #B8860B)',
                  position: 'absolute',
                  top: 0,
                  left: 0,
                  right: 0
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 8px 24px rgba(184, 134, 11, 0.3), inset 0 2px 4px rgba(255, 255, 255, 0.2)',
          zIndex: 1000,
          transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
          backdropFilter: 'blur(10px)'
        }}
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = '0 12px 32px rgba(184, 134, 11, 0.4), inset 0 2px 4px rgba(255, 255, 255, 0.3)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'translateY(0) scale(1)';
          e.currentTarget.style.boxShadow = '0 8px 24px rgba(184, 134, 11, 0.3), inset 0 2px 4px rgba(255, 255, 255, 0.2)';
        }}
